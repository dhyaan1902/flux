      ...
      <div className="relative z-10 max-w-3xl w-full">
        ...
        <form onSubmit={handleSubmit} className="relative w-full max-w-xl mx-auto">
          <div className="relative group">
            <div className="absolute -inset-0.5 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-2xl blur opacity-30 group-hover:opacity-75 transition duration-200"></div>
            <div className="relative flex items-center bg-[#1a1b26] rounded-xl border border-white/10 shadow-2xl">
              ...
              <input
                ...
                className="w-full bg-transparent py-4 pl-12 pr-14 text-white placeholder-gray-500 focus:outline-none focus:ring-0 rounded-xl"
                disabled={isLoading}
              />
