...
export const TopBar: React.FC<TopBarProps> = ({
    ...
    return (
        <div className={`fixed top-0 left-0 right-0 z-40 transition-all duration-300 ease-in-out pt-safe ${scrolled ? 'glass pb-2' : 'bg-gradient-to-b from-black/80 to-transparent pb-4'
            }`}>
            <div className="flex items-center justify-between px-5 py-3">
                ...
                <div className="flex items-center gap-4 text-white">
                    <div className="w-8 h-8 rounded-md bg-blue-600 flex items-center justify-center text-[11px] font-bold border border-white/20 active:scale-90 transition-transform shadow-lg shadow-blue-900/20">
            ...
            <div className={`w-full overflow-x-auto scrollbar-hide px-5 transition-all duration-300 ease-in-out overflow-hidden ${scrolled ? 'h-0 opacity-0 pointer-events-none' : 'h-10 opacity-100'
                }`}>
